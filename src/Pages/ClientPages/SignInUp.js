  ...
  return (
    <>
      <div className="signInUp">
        {starts()}
        <div className="signInUp__moon"></div>
        <img className="signInUp_forest" src={forest} alt={forest}></img>
        <div className="signInUp__main">
          <div className="signInUp__container" id="signInUp__container">
            <div className="form__container signUp__container">
              <div className="form__content">
                <h3>Đăng Ký</h3>
                <div className="signUp__social">
                  <a href="1" className="signUp__social--facebook">
                    {" "}
                    <i className="fab fa-facebook-f"></i>{" "}
                  </a>
                  <a href="2" className="signUp__social--google">
                    {" "}
                    <i className="fab fa-google-plus-g"></i>{" "}
                  </a>
                  <a href="3" className="signUp__social--linked">
                    {" "}
            ...
            <div className="signInUp__overlay">
              <div className="overlay">
                <div className="overlay__panel overlay__left">
                  <h3>Chào Mừng Trở Lại!</h3>
                  <p>Đăng nhập để mua vé và nhận nhiều ưu đãi từ G2 Cinema.</p>
                  <button
                    className="ghost button__signInUp"
                    id="button__signIn"
                    onClick={() => {
                      document
                        .getElementById("signInUp__container")
                  ...
                  >
                    <g id="Layer_2" data-name="Layer 2">
                      <g id="Слой_1" data-name="Слой 1">
                        ...
                        <g
                          id="CHARACTER_ON_BICYCLE"
                          data-name="CHARACTER ON BICYCLE"
                        >
                ...
                <div className="overlay__panel overlay__right">
                  <h3>Xin Chào, Bạn!</h3>
                  <p>
                    Vui lòng nhập các thông tin của bạn và bắt đầu chặng hành
                    trình với G2 Cinema.
                  </p>
                  <button
                    className="ghost button__signInUp"
                  ...
                  >
                    <g id="Layer_2" data-name="Layer 2">
                      <g id="Слой_1" data-name="Слой 1">
                        ...
                        <g
                          id="CHARACTER_ON_SCOOTER"
                          data-name="CHARACTER ON SCOOTER"
                        >
                          <g id="SCOOTER">
                            <path

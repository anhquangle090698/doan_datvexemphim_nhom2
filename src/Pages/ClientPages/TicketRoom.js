...
export default function TicketRoom(props) {
    ...
    const logicNumberChair = (numberChair) => { 
        ...
        numberChair % 16 === 8 ? '08' :
        numberChair % 16 === 9 ? '09' :
        numberChair % 16 === 10 ? '10' :
        numberChair % 16 === 11 ? '11' :
        numberChair % 16 === 12 ? '12' :
        numberChair % 16 === 13 ? '13' :
        numberChair % 16 === 14 ? '14' :
        numberChair % 16 === 15 ? '15' :
        numberChair % 16 === 0 ? '16' : ''
    }

    const logicCharacterChair = (numberChair) => { 
        return numberChair / 1 === 1 ? <span className="ticket__diagram--character">A</span> :
        numberChair / 17 === 1 ? <span className="ticket__diagram--character">B</span> :
        numberChair / 33 === 1 ? <span className="ticket__diagram--character">C</span> :
        numberChair / 49 === 1 ? <span className="ticket__diagram--character">D</span> :
        numberChair / 65 === 1 ? <span className="ticket__diagram--character">E</span> :
        numberChair / 81 === 1 ? <span className="ticket__diagram--character">F</span> :
        numberChair / 97 === 1 ? <span className="ticket__diagram--character">G</span> :
        numberChair / 113 === 1 ? <span className="ticket__diagram--character">H</span> :
        numberChair / 129 === 1 ? <span className="ticket__diagram--character">I</span> :
        numberChair / 145 === 1 ? <span className="ticket__diagram--character">J</span> : ''
    }
